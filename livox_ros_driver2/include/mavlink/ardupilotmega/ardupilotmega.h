...
#define MAVLINK_ARDUPILOTMEGA_XML_HASH -5498317018139587971
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_SIYI_UOM_SET_ACTIVATION_STATE=50001, /* Set persistent real-name (UOM) activation state on the flight controller. |0=cancel activation, 1=activate.| Reserved, set to 0.| Reserved, set to 0.| Reserved, set to 0.| Reserved, set to 0.| Reserved, set to 0.| Reserved, set to 0.|  */
