...
static void mavlink_test_illuminator_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_illuminator_status_t packet_in = {
        963497464,963497672,73.0,101.0,129.0,157.0,185.0,213.0,101,168,235,46,113,180
    };
    mavlink_illuminator_status_t packet1, packet2;
        ...
        packet1.color_mode = packet_in.color_mode;
        packet1.gimbal_device_id = packet_in.gimbal_device_id;
    ...
    mavlink_msg_illuminator_status_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_illuminator_status_send(MAVLINK_COMM_1 , packet1.uptime_ms , packet1.enable , packet1.mode_bitmask , packet1.error_status , packet1.mode , packet1.brightness , packet1.strobe_period , packet1.strobe_duty_cycle , packet1.temp_c , packet1.min_strobe_period , packet1.max_strobe_period , packet1.zoom_level , packet1.color_mode , packet1.gimbal_device_id );
    mavlink_msg_illuminator_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
